...
import { filterLocations, formatReviewedDate, loadLocations } from "@/lib/locations";
...
function App() {
  ...
  useEffect(() => { loadLocations().then(setLocations).catch((reason: unknown) => setError(reason instanceof Error ? reason.message : "The map data could not be loaded.")); }, []);
